                ...
                <div class="col-lg-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <div class="form">
                                <form class="cmxform form-horizontal " id="signupForm" method="post" action="<?php echo base_url('user/prosesedit') ?>" novalidate="novalidate">
                                    <input type="hidden" value="<?php echo $user['id_user'] ?>" name="id_user">
                                    <div class="form-group ">
                                        <label for="nama" class="control-label col-lg-3">Nama</label>
                                        <div class="col-lg-6">
                                            <input class=" form-control" value="<?php echo $user['nama'] ?>" id="nama" name="nama" type="text">
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <label for="tanggal_lahir" class="control-label col-lg-3">Tanggal Lahir</label>
                                        <div class="col-lg-6">
                                            <input class=" form-control" value="<?php echo $user['tanggal_lahir'] ?>" id="tanggal_lahir" name="tanggal_lahir" type="text">
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <label for="tempat_lahir" class="control-label col-lg-3">Tempat Lahir</label>
                                        <div class="col-lg-6">
                                            <input class="form-control" value="<?php echo $user['tempat_lahir'] ?>" id="tempat_lahir" name="tempat_lahir" type="text">
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <label for="alamat" class="control-label col-lg-3">Alamat</label>
                                        <div class="col-lg-6">
                                            <input class="form-control" value="<?php echo $user['alamat'] ?>" id="alamat" name="alamat" type="text">
                                        </div>
                                    </div>
                                    <div class="form-group ">
