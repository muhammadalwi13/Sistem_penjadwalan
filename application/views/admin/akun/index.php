...
<section id="main-content">
 ...
 <div class="panel panel-default">
    ...
    <div class="page-title">
        ...
        <a href="<?php echo base_url('akun/tambah') ?>/<?php echo $b; ?>"><button type="submit" class="btn btn-success btn-sm"><i class="fa fa-plus"></i>Tambah</button></a>
        </ol>
    </div>
    <div>
      <table class="table" ui-jq="footable" ui-options='{
        ...
        <td>
                <a href="<?php echo base_url('akun/edit') ?>/<?php echo $row['id_user']; ?>"><button class="btn btn-primary">Edit</button></a>
                <a href="<?php echo base_url('akun/hapus'); ?>/<?php echo $row['id_user']; ?>"><button class="btn btn-danger" onclick="return confirm('Apakah anda yakin menghapus?')">Hapus</button></a>
