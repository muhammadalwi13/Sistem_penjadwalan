                ...
                <div class="col-lg-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <div class="form">
                                <form class="cmxform form-horizontal " id="signupForm" method="post" action="<?php echo base_url('akun/prosestambah') ?>" novalidate="novalidate">
                                    <input type="hidden" name="id_user" id="id_user" value="<?php echo $b; ?>">
