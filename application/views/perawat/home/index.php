    ...
    <ul class="nav pull-right top-menu">
        ...
        <li class="dropdown">
            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                ...
                <span class="username">Perawat</span>
                <b class="caret"></b>
            </a>
            <ul class="dropdown-menu extended logout">
                <li><a href="<?php echo base_url('logout/index_perawat') ?>"><i class="fa fa-key"></i> Log Out</a></li>
            </ul>
        </li>
    ...
    <div id="sidebar" class="nav-collapse">
        ...
        <div class="leftside-navigation">
               <ul class="sidebar-menu" id="nav-accordion">
                <li>
                    <a href="<?php echo base_url('home/index_perawat'); ?>">
                        <i class="fa fa-home"></i>
                        <span>Home</span>
                    </a>
                </li>
                <li>
                    <a href="<?php echo base_url('jadwal/index_perawat'); ?>">
						...
						<div class="agileinfo-grap">
							<div class="agileits-box">
								<header class="agileits-box-header clearfix">
									<h3>Sistem Informasi Penjadwalan Perawat</h3>
										<center><img width="300" height="500" src="<?php echo base_url() ?>/assets/images/hospital-1706646_1280.png"></center>
								</header>
